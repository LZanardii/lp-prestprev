...
import imgProfile from "../../assets/matheus_krause.png"
import "./style.css"
...
const Sobre = () => {
  ...
  const paragrafoSobre = (
    <>
      <p>
        A PrestPrev Serviços Previdenciários é um escritório especializado em documentação previdenciária, comprometido em oferecer soluções ágeis e eficazes para garantir os direitos dos nossos clientes junto ao INSS.          
      </p>
      <p>
    ...
    <div className="sobre">
      ...
      <Modal show={show} size="lg" onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <p>
            Meu nome é <b>Matheus Krause da Silva</b>, sou empresário e fundador da <b>PrestPrev Serviços Previdenciários</b>, escritório especializado em documentação previdenciária.
          </p>
          <p>
          ...
          <p>
            Formado em Direito, uno conhecimento jurídico e prática documental para oferecer um atendimento preciso e eficiente. Meu compromisso é auxiliar clientes em processos de aposentadoria, Benefício de Prestação Continuada (BPC/LOAS) para pessoas com deficiência e idosos, auxílio por incapacidade temporária (auxílio-doença), auxílio-reclusão e salário-maternidade, sempre com transparência, responsabilidade e dedicação. Meu objetivo é orientar cada cliente de forma clara e segura na busca pelos seus direitos previdenciários.
          </p>
          <p>
